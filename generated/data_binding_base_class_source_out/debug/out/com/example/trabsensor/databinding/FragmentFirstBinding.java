...
public final class FragmentFirstBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout sensor3;
  ...
  private FragmentFirstBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonFirst,
      @NonNull ConstraintLayout sensor3, @NonNull TextView textviewFirst) {
  ...
  public static FragmentFirstBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ConstraintLayout sensor3 = (ConstraintLayout) rootView;
      ...
      return new FragmentFirstBinding((ConstraintLayout) rootView, buttonFirst, sensor3,
          textviewFirst);
    }
